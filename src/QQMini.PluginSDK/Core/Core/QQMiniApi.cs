...
namespace QQMini.PluginSDK.Core.Core
{
	internal static class QQMiniApi
	{
		...
		public static extern int QMApi_GetFriendList(int nAuthCode, long lResponseQQ, bool bUseCache, IntPtr szFriendList);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetFriendInfo), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetFriendInfo(int nAuthCode, long lResponseQQ, long lDestQQ, bool bUseCache, IntPtr szFriendInfo);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetStrangerInfo), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetStrangerInfo(int nAuthCode, long lResponseQQ, long lDestQQ, bool bUseCache, IntPtr szStrangerInfo);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetGroupList), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetGroupList(int nAuthCode, long lResponseQQ, bool bUseCache, IntPtr szGroupList);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetGroupInfo), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetGroupInfo(int nAuthCode, long lResponseQQ, long lDestGroup, bool bUseCache, IntPtr szGroupInfo);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetGroupMemberList), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetGroupMemberList(int nAuthCode, long lResponseQQ, long lDestGroup, bool bUseCache, IntPtr szGroupManagerList);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetGroupMemberInfo), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetGroupMemberInfo(int nAuthCode, long lResponseQQ, long lDestGroup, long lDestQQ, bool bUseCache, IntPtr szGroupMemberInfo);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetGroupManagerList), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetGroupManagerList(int nAuthCode, long lResponseQQ, long lDestGroup, bool bUseCache, IntPtr szGroupManagerList);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetDiscussList), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetDiscussList(int nAuthCode, long lResponseQQ, bool bUseCache, IntPtr szDiscussList);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetDiscussMemberList), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetDiscussMemberList(int nAuthCode, long lResponseQQ, long lDestDiscuss, bool bUseCache, IntPtr szDiscussMemberList);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetCookies), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetCookies(int nAuthCode, long lResponseQQ, IntPtr szCookies);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetBkn), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetBkn(int nAuthCode, long lResponseQQ, IntPtr szBkn);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetOnlineStatus), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetOnlineStatus(int nAuthCode, long lResponseQQ, long lDestQQ, IntPtr nOnlineStatus);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetGroupBanStatus), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetGroupBanStatus(int nAuthCode, long lResponseQQ, long lDestGroup, long lDestQQ, bool bIsBan);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetFriendVerifyMode), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetFriendVerifyMode(int nAuthCode, long lResponseQQ, long IDestQQ, int nFriendVerify);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetIsOnline), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetIsOnline(int nAuthCode, long lResponseQQ, long IDestQQ, bool bIsOnline);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetIsReceiveOnlineTempMessage), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetIsReceiveOnlineTempMessage(int nAuthCode, long lResponseQQ, long IDestQQ, bool bIsOnline);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetDiscussName), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetDiscussName(int nAuthCode, long lResponseQQ, long lDestDiscuss, IntPtr szDiscussName);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetDiscussAddLink), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetDiscussAddLink(int nAuthCode, long lResponseQQ, long lDestDiscuss, IntPtr szDiscussAddLink);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetGroupGiftList), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetGroupGiftList(int nAuthCode, long lResponseQQ, IntPtr szGiftList);

		[DllImport(LibraryName, EntryPoint = nameof(QMApi_GetRandomGroupGift), CallingConvention = CallingConvention.StdCall)]
		public static extern int QMApi_GetRandomGroupGift(int nAuthCode, long lResponseQQ, long lDestGroup, IntPtr szGift);
		...
		public static extern int QMApi_SendLike(int nAuthCode, long lResponseQQ, long IDestQQ, IntPtr nCount);
		...
		public static extern int QMApi_SendDiscussInviteRequest(int nAuthCode, long lResponseQQ, long lDestDiscuss, IntPtr lDestQQ);
		...
		public static extern int QMApi_RemoveGroupMember(int nAuthCode, long lResponseQQ, long lDestGroup, long lDestQQ, bool bIsRefuseAccept);
		...
		public static extern int QMApi_CreateDiscuss(int nAuthCode, long lResponseQQ, long lDestQQ, long lDiscussId);
